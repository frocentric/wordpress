...
namespace NFMailchimp\EmailCRM\Mailchimp\Interfaces;
...
interface MailchimpApi
{
     ...
     *
     * @param string $list_id The ID of the list.
     * @param string $interest_category_id The ID of the interest category.
     * @param array $parameters Associative array of optional request parameters.
     *
     * @return object
     * @throws MailchimpAPIException
     ...
     * @param array $parameters Associative array of optional request parameters.
     * @param bool $batch TRUE to create a new pending batch operation.
     *
     * @return object
     * @throws MailchimpAPIException
     ...
     * @param array $tokens Associative array of tokens and values to replace in the path.
     * @param array $parameters Associative array of parameters to send in the request body.
     * @param bool $batch TRUE if this request should be added to pending batch operations.
     * @param bool $returnAssoc TRUE to return Mailchimp API response as an associative array.
     *
     * @return mixed
