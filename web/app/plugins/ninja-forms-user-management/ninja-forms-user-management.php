...
final class NF_UserManagement
{
     ...
     * @return array of setting_name => setting_value(with mergetag formatting removed)
     *
     * example return username => username_1489426787243
     */
    ...
    public function get_field_id($fields, $settings)
    {
        ...
        foreach ($fields as $field) {
            ...
            foreach ($settings as $setting_key => $setting_value) {
                ...
                if ($setting_value == $field_key) {
                    //Builds the return array of the setting value and field IDs
                    $field_ids[$setting_key] = $field->get_id();
                }
            }
        }
        return $field_ids;
    ...
    public function register_templates($templates)
    {
        ...
        $templates['login-form'] = array(
            ...
            'template-desc' => __(
                'Allow your users to login. You can add and remove fields as needed.',
        ...
        $templates['update-profile'] = array(
            ...
            'template-desc' => __(
                'Allow users to update their profiles, including custom user meta. You can add and remove fields as needed.',
                'ninja-forms-user-management'
            ),
    ...
    public function nf_user_management_submissions_access_settings()
    {
        register_rest_route(
            'nf-user-management',
            '/save-submissions-access-settings',
            [
                'methods' => 'POST',
                'args' => [
                    'settings' => [
        ...
        register_rest_route(
            'nf-user-management',
            '/get-submissions-access-settings-meta',
            [
                'methods' => 'GET',
