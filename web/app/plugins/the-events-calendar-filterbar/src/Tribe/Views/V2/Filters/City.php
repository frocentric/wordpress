<?php
/**
 * An implementation of the City filter that applies to specific contexts.
 *
 * @since   4.9.0
 *
 ...
 * @package Tribe\Events\Filterbar\Views\V2\Filters
 */
class City extends \Tribe__Events__Filterbar__Filters__City {
	use Context_Filter;
	use Concatenated_Value_Handling;

	/**
	 * Builds the value that should be set in the query argument for the City filter.
	 *
	 * @since 4.9.0
	 *
