...
function wpematico_pro_help_campaign($helpsettings) {
	...
	$helpsettings['Campaign Options']['campaign_date_tag'] = array(
		'title'	 => __('Use a custom feed tag to set the date.', 'wpematico'),
		'tip'	 => __('You can set in each campaign which feed item tag should be used to set the date of each post. The value must be compatible with the strtotime function.', 'wpematico'),
	);
