 ...
 */
class InstructionFileMetadataStrategy implements \NF_FU_VENDOR\Aws\Crypto\MetadataStrategyInterface
{
     ...
     *                            object keys.
     */
    public function __construct(\NF_FU_VENDOR\Aws\S3\S3Client $client, $suffix = null)
    {
