<?php
/**
 * Manages the list event recurring icon the Views V2 implementation.
 */
...
/**
 * Class List_Event_Recurring_Icon
 *
 * @since   4.7.8
 * @package Tribe\Events\Pro\Views\V2\Views\Partials
 */
class List_Event_Recurring_Icon implements View_Partial_Interface {
	/**
